import{a as c}from"./axiosConfig-C-8zFsPD.js";const i="https://livejs-api.hexschool.io/api/livejs/v1/admin",l="goushs2024",E="i0T3K2YLg6PFBZsuu4BkvMVJXQH3",u={headers:{Authorization:E}},O=document.querySelector(".orderWrap"),L=document.querySelector(".deleAllOrderBtn");let h=[],$=[];document.addEventListener("DOMContentLoaded",y);window.putOrder=A;window.deleOrder=g;window.deleAllOrders=v;function y(){f(),D(),b()}function D(){O.addEventListener("click",t=>{t.preventDefault();const e=t.target.dataset.id;if(t.target.classList.contains("putOrder")){const r=t.target.textContent==="已處理";A(e,!r)}t.target.classList.contains("deleOrderBtn")&&g(e)})}function b(){L.addEventListener("click",t=>{t.preventDefault(),v()})}function F(t){let e="";return t.products.forEach((r,n)=>{e+=`${r.title} * ${r.quantity}`,n!==t.products.length-1&&(e+="<br/>")}),`
    <tr>
      <td> ${t.id} </td>
      <td> ${t.user.name} </td>
